...
const project = new AwsCdkTypeScriptApp({
  ...
  dependencies: {
    "aws-cdk-serverless-timer": "file:../serverless-timer",
  },
  deps: ["axios", "uuid", "@types/uuid"],
  devDependencies: {
    "aws-cdk-exec": "^0.0.5",
    "aws-sdk": "^2.773.0",
  ...
  // workflowBootstrapSteps: "yarn install --frozen-lockfile (used by jsii projects since tsconfig.json is generated by the jsii compiler). */
